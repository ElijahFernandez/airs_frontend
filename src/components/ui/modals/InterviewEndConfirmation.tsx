...
const InterviewEndConfirmation: React.FC<InterviewEndConfirmationProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-gradient-to-br from-blue-950 from-10% via-indigo-950 via-30% to-blue-950 to-90% p-6 rounded-2xl shadow-xl w-[24rem] h-[16rem] flex flex-col justify-between items-center">
        
        {/* Title & Message Section */}
        <div className="flex-grow flex flex-col items-center justify-center text-center space-y-4 px-6">
          <h2 className="text-white text-2xl font-bold">End Interview?</h2>
